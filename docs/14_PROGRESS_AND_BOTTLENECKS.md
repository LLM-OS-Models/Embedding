...
H100 100%, trainer-reported 약 59.30GiB(`nvidia-smi` 약 61.8GiB), 약 23.3초/step이며
240/800 검증 시점의 잔여 추정은 약 3시간 38분이다. 200K와 1M
...
| LoRA r64 | 174.588M | 10K **22.17GiB**, 50K long mix trainer **59.30GiB** / device **61.8GiB** 실측 | 10K 완료, 50K 240/800 검증 완료; best 200 |

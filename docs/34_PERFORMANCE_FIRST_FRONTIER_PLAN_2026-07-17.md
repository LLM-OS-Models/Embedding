...
| Python 환경 | NFS `.venv-hf-tools`, `.venv-train-fa2`, `.venv-mteb` 복원; 8B backward와 전체 test 169/169 통과 |
...
2. clean dev near-tie 안에서 general/target/legal/long adapter linear soup

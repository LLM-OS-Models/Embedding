...
export DERIVED_REPO=LLM-OS-Models2/korean-embedding-sionic-health-quantile-hn7-replay-v1
export DERIVED_TITLE="Korean Sionic Health Quantile HN7 with General Replay"
export MODEL_REPO=LLM-OS-Models2/qwen3-embedding-8b-ko-sionic-health-target-adapted-v1

...
| MTEB/FAISS 평가 환경 | NFS `.venv-mteb` 복원; MTEB 2.18.0, FAISS 1.14.3, NumPy 1.26.4, Transformers 5.12.1 import gate·전체 test 213/213 통과 | [`bootstrap_mteb_env.sh`](scripts/bootstrap_mteb_env.sh) |
